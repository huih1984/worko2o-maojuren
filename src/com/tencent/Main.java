...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //--------------------------------------------------------------------
            //温馨提示，第一次使用该SDK时请到com.com.tencent.common.Configure类里面进行配置
            //--------------------------------------------------------------------
            ...
            // Util.log(Signature.getSignFromResponseString(Util.getLocalXMLString("/test/com/com.tencent/business/refundqueryserviceresponsedata/refundquerysuccess2.xml")));
