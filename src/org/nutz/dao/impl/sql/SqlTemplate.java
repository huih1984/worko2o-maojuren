...
public class SqlTemplate {
     ...
     *
     * @param sql    包含变量占位符的SQL
     * @param params 参数map,无参数时，可为null
     * @return SQL 语句所影响的行数
     */
     ...
     * @param sql      包含变量占位符的SQL
     * @param params   参数map 无参数时，可为null
     * @param classOfT 对象类型，SQL查询结果所对应的类型，如Date.class等
