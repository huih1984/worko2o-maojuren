...
!function (a) {
    ...
    function b(b, c) {
        ...
        this.$group = a.create("div").addClass("checkbox btn-group"), this.$buttons = a.create("a", "a").addClass("btn");
    ...
    }, a.fn.checkboxpicker.defaults = {style: !1, defaultClass: "btn-default clrbfff clrbdccc clr333", disabledCursor: "not-allowed", offClass: "btn-danger", onClass: "btn-success clr333", offLabel: "否", onLabel: "是", offTitle: !1, onTitle: !1, toggleKeyCodes: [13, 32], warningMessage: "Please do not use Bootstrap-checkbox element in label element."}, a.fn.checkboxpicker
});