...
!function () {
    ...
    var arrDbClick = {a: "Link", img: "Img", embed: "Embed"}, uploadInputname = "filedata", arrEntities = {"<": "&lt;", ">": "&gt;", '"': "&quot;", "®": "&reg;", "©": "&copy;"}, regEntities = /[<>"®©]/g, Xheditor = function (textarea, options) {
        ...
        this.init = function () {
            ...
            h > 0 && _jShadow.css({left: d + h, top: e + h, width: _jPanel.outerWidth(), height: _jPanel.outerHeight()}).show();
            var i = $("#" + idContainer).offsetParent().css("zIndex");
            i && !isNaN(i) && (_jShadow.css("zIndex", parseInt(i, 10) + 1), _jPanel.css("zIndex", parseInt(i, 10) + 2), _jCntLine.css("zIndex", parseInt(i, 10) + 3)), _jPanel.css({left: d, top: e}).show(), b || setTimeout(function () {
            ...
            if (b.e)b.e.call(_this); else switch (a = a.toLowerCase()) {
                ...
                case"blocktag":
                    ...
                    $.each(settings.listBlocktag, function (a, b) {
                        e.push({s: "<" + b.n + ">{#listBlocktag." + b.n + "}</" + b.n + ">", v: "<" + b.n + ">", t: "{#listBlocktag." + b.n + "}"})
                ...
                case"fontface":
                    ...
                    $.each(getLang("listFontname"), function (a, b) {
                        b.c = b.c ? b.c : b.n, f.push({s: '<span style="font-family:' + b.c + '">' + b.n + "</span>", v: b.c, t: b.n})
                ...
                case"fontsize":
                    ...
                    $.each(settings.listFontsize, function (a, b) {
                        g.push({s: '<span style="font-size:' + b.s + ';">{#fontsize.' + b.n + "}(" + b.s + ")</span>", v: a + 1, t: "{#fontsize." + b.n + "}"})
